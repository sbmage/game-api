...
public class AES256 {
     ...
     * key size in bytes.
     */
    public static final int KEY_SIZE_IN_BYTES = KEY_SIZE / 16;
     ...
     */
    private static void copy(final Cipher cipher, final InputStream source,
    ...
    public static String encryptToHEX(final byte[] key, final byte[] iv,
                                      final byte[] decrypted)
        throws IOException, IllegalBlockSizeException, BadPaddingException {
